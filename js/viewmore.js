        ...
        try {
            ...
            if (userDetails) {
                ...
                if (userDetails.id === userId) {
                   ...
                   errorNotification("User is viewing their own laptop. Rating disabled.", 5);
...
document.getElementById('emoji-display').style.display = 'block'; // Show the emoji display
        }
    });
});
async function submitRating(userId, laptopId) {
    ...
    try {
        ...
        if (existingRatings.length > 0) {
            errorNotification("You have already rated this laptop 🙂.", 3);
        ...
        successNotification("Rated Successfully 😍!",10);
